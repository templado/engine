...
class NestedSnippetTest extends TestCase {
    ...
    public function testReplacementWithMultipleSiblingBug(): void {
        ...
        $dom1->loadXML('<page:snippet xmlns:page="https://templado.io/snippets/1.0" id="foo"><p><a /></p> text <p><b id="bar" /></p></page:snippet>');
        ...
        $expected->loadXML('<?xml version="1.0" ?><test><p><a /></p> text <p><h4 id="bar">text</h4></p><other /></test>');
