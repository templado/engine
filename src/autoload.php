    ...
    function($class) {
        ...
        if ($classes === null) {
            $classes = array(
                ...
                'theseer\\templado\\emptyelementsfilter' => '/filters/EmptyElementsFilter.php',
                'theseer\\templado\\exception' => '/Exception.php',
                'theseer\\templado\\filename' => '/FileName.php',
                'theseer\\templado\\filter' => '/filters/Filter.php',
                ...
                'theseer\\templado\\selector' => '/selectors/Selector.php',
                'theseer\\templado\\simpleasset' => '/asset/SimpleAsset.php',
                ...
                'theseer\\templado\\xpathselector' => '/selectors/XPathSelector.php'
            );
        }
        $cn = strtolower($class);
        if (isset($classes[$cn])) {
